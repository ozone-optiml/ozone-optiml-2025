...
if __name__=='__main__':
    ...
    def evaluate(loader, split_name):
        output_root = os.path.join(os.path.dirname(__file__), 'true_output')
        model_dir = os.path.join(output_root, 'true')
        split_dir = os.path.join(model_dir, split_name)
        os.makedirs(split_dir, exist_ok=True)

        for _, _, true_output, paths in tqdm(loader, desc=f"{split_name}"):
